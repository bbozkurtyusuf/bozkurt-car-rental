...
<head>
	...
	<title>Araç Kiralama Portalı | Yönetici Görsel 5 Güncelleme</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Araç Görseli 5 </h2>

						<div class="row">
							<div class="col-md-10">
								<div class="panel panel-default">
									<div class="panel-heading">Araç Görseli 5 Detaylar</div>
...
<div class="form-group">
												<label class="col-sm-4 control-label">Mevcut Görsel5</label>
<?php 
$id=intval($_GET['imgid']);
...
<?php }}?>
											...
											<div class="form-group">
												<label class="col-sm-4 control-label">Yeni Görsel 5 Yükle<span style="color:red">*</span></label>
												<div class="col-sm-8">
