...
<head>
	...
	<title>Araç Kiralama Portalı | Yönetici Bilgi Güncelleme</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">İletişim Bilgilerini Güncelle</h2>
...
<?php }} ?>
											...
											<div class="form-group">
												<div class="col-sm-8 col-sm-offset-4">
													...
													<button class="btn btn-primary" name="submit" type="submit">Güncelle</button>
												</div>
											</div>
