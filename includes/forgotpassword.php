...
<div class="modal fade" id="forgotpassword">
  ...
  <div class="form-group">
              ...
              <div class="text-center">
                <p class="gray_text">Güvenlik nedeniyle şifrenizi saklamıyoruz. Şifreniz sıfırlanacak ve yenisi size gönderilecektir..</p>
                <p><a href="#loginform" data-toggle="modal" data-dismiss="modal"><i class="fa fa-angle-double-left" aria-hidden="true"></i> Girişe Dön</a></p>
              </div>
            </div>
          </div>
        </div>
