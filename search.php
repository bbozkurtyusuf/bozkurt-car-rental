...
<title>Araç Kiralama Portalı | Araç Listesi</title>
<!--Bootstrap -->
  ...
  <div class="container">
    <div class="page-header_wrap">
      <div class="page-heading">
        <h1>Anahtar Kelime Arama Sonucu "<?php echo $_POST['searchdata'];?>"</h1>
      </div>
...
$cnt=$query->rowCount();
?>
<p><span><?php echo htmlentities($cnt);?>  Arama ile Eşleşen Listelemeler Bulundu</span></p>
</div>
</div>
